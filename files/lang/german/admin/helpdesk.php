...
define('HELPDESK_TEXT_MENU_STAFF', 'Supporter');
define('HELPDESK_TEXT_MENU_DEPARTMENTS', 'Abteilungen');
define('HELPDESK_TEXT_MENU_STATUS', 'Status');
define('HELPDESK_TEXT_MENU_PRIORITIES', 'Priorit&auml;ten');
define('HELPDESK_TEXT_MENU_CONFIG', 'Konfiguration');


/**
 * Staff
 */
define('HELPDESK_TEXT_STAFF_FIRSTNAME', 'Vorname');
define('HELPDESK_TEXT_STAFF_LASTNAME', 'Nachname');
define('BUTTON_NEW_STAFF', 'Neuer Supporter');
define('HELPDESK_TEXT_STAFF_EDIT_CUSTOMER', 'Kunde');
define('HELPDESK_TEXT_STAFF_EDIT_RECEIVE_EMAIL', 'E-Mail senden');
define('HELPDESK_TEXT_STAFF_EDIT_ORDER_BY', 'Sortierung');
define('HELPDESK_TEXT_STAFF_EDIT_STATUS', 'Status');
define('HELPDESK_TEXT_STAFF_EDIT_PRIORITY', 'Priorit&auml;t');
define('HELPDESK_TEXT_STAFF_EDIT_DEPARTMENTS', 'Abteilungen');
define('HELPDESK_TEXT_STAFF_EDIT_LANGUAGES', 'Sprachen');
define('HELPDESK_TEXT_STAFF_DELETE_CONFIRM', 'Wollen Sie wirlich diesen Support Mitarbeiter l&ouml;schen?');
...
define('HELPDESK_TEXT_DEPARTMENTS_SORT_ORDER', 'Sortierung');
define('HELPDESK_TEXT_DEPARTMENTS_DELETE_CONFIRM', 'Wollen Sie diese Abteilung wirklich l&ouml;schen?');
define('BUTTON_NEW_DEPARTMENT', 'Neue Abteilung anlegen');
...
define('HELPDESK_TEXT_STATUS_SORT_ORDER', 'Sortierung');
define('HELPDESK_TEXT_STATUS_COLOR', 'Farbe');
